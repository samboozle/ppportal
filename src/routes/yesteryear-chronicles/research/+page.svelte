          ...
          <table class="table table-compact table-zebra w-full">
            <thead class="w-full rounded-none">
              <tr>
                <th> actions </th>
                <th>
                  <button class="sort-button" on:click={() => setSortFn("year")}> year </button>
                </th>
                <th>
                ...
                <tr>
                  <th class="space-x-0">
                    <button
                      class="emoji-button"
                      on:click={() =>
                        yesteryearEpisode.addBulkStory("shortStoriesTopics", `${text} (${year})`)}
                      >📓</button
                    >
                    <button
                      class="emoji-button"
                      on:click={() =>
                        yesteryearEpisode.addDeepDive("deepDiveOneTopic", `${text} (${year})`)}
                      >1️⃣</button
                    >
                    <button
                      class="emoji-button"
                      on:click={() =>
                        yesteryearEpisode.addDeepDive("deepDiveTwoTopic", `${text} (${year})`)}
                      >2️⃣</button
                    >
                    <button
                      class="emoji-button"
                      on:click={() =>
                        yesteryearEpisode.addBulkStory("popCultureTopics", `${text} (${year})`)}
                      >🍿</button
                    >
                  </th>
                  <th>{year || "N/A"}</th>
                ...
                <tr>
                  <th>
                    <button
                      ...
                      on:click={() => yesteryearEpisode.addBulkStory("holidays", text)}>🎊</button
                    >
                  </th>
                  <th class="text-xs">{text}</th>
                </tr>
